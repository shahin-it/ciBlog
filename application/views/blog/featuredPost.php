...
<div id="carouselExampleIndicators" class="carousel skui-carousel slide carousel-fade" data-ride="carousel">
		...
		<?php foreach ($slideItems as $i=>$post) {?>
			<div class="carousel-item <?php echo ($i == 0 ? "active":"")?> jumbotron p-3 p-md-5 text-white rounded bg-dark h-100">
				<div class="col-md-6 px-0">
					<h1 class="font-italic"><?php echo $post["name"]?></h1>
					<p class="lead my-3 overflow-hide"><?php echo $post["summary"]?></p>
